...
public class UserController {
	...
	public String greet() {
		return rt.getForObject("http://localhost:8070/greet", String.class);
	}
	...
	public UserDto getOrdeDetails(@PathVariable int userId) {
		...
		ArrayList<OrderDto> ol = rt.getForObject("http://localhost:8070/order/"+userId,new ArrayList<OrderDto>().getClass());
		usrdto.setOrders(ol);
		return usrdto;
	}
